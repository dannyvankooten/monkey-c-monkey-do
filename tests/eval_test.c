...
void test_if_else_expressions()
{
    struct
    {
        ...
        {"if (true) { 10 }", .value.integer = 10, OBJ_INT},
        {"if (false) { 10 }", {0}, OBJ_NULL},
        {"if (1) { 10 }", .value.integer = 10, OBJ_INT},
        {"if (1 < 2) { 10 }", .value.integer = 10, OBJ_INT},
        {"if (1 > 2) { 10 }", {0}, OBJ_NULL},
        {"if (1 > 2) { 10 } else { 20 }", .value.integer = 20, OBJ_INT},
        {"if (1 < 2) { 10 } else { 20 }", .value.integer = 10, OBJ_INT},
    };
...
void test_return_statements()
{
    struct
    {
        ...
        {"return 10;", .value.integer = 10, OBJ_INT},
        {"return 10; 9;", .value.integer = 10, OBJ_INT},
        {"return 2 * 5; 9;", .value.integer = 10, OBJ_INT},
        {"9; return 2 * 5; 9;", .value.integer = 10, OBJ_INT},
        {"                      \
        if (10 > 1) {           \
            if (10 > 1) {       \
                return 10;      \
